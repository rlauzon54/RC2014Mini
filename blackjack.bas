...
140 PRINT:INPUT"INSTRUCTIONS? (YES-NO) ";M$: IF M$="NO" THEN 160
150 IF M$="YES" THEN GOSUB 1640:GOTO 160
151 GOTO 140
160 R=16:PRINT"HOW MANY DECKS (1-4)";
170 INPUT N:IFN<1ORN>4THENPRINT"1 TO 4 DECKS ONLY. REENTER";:GOTO 170
...
230 GOTO 200
240 GOSUB 930:H(1)=U:N=Q(2):PRINT
241 PRINT"MY UP CARD";:GOSUB1050:N=P(R,1)
250 PRINT : PRINT"YOUR 1ST CARD";:GOSUB 1050
251 PRINT"YOUR 2ND CARD";:N=P(R,2)
260 GOSUB 1050
270 GOSUB1170:IF M<>11 THEN 280
271 GOSUB 1550
...
390 IF A<=E THEN 400
400 GOSUB 1220
401 M=S(G):M=M+1:S(G)=M:N=D(A):P(G,M)=N:PRINT"YOUR CARD IS";
402 GOSUB 1050
...
721 O(G)=O(G)-1:X(G)=X(G)-10:GOTO1350
730 N=P(G,1):Y=Y+1:GOSUB 1010:M=N:N=P(G,2):GOSUB1010:IFM=NTHEN 760
...
890 PRINT CHR$(26):PRINT "I'M SHUFFLING.... ":FOR I=B TO E
900 C=RND(1)*E:IF C<B THEN 900
901 L=D(I):D(I)=D(C):D(C)=L:NEXTI
910 A=B:RETURN
...
1230 FOR I=1TOK:A=A-1:J=D(I):D(I)=D(A):D(A)=J:NEXTI:B=K+1:GOSUB 890
1231 RETURN
...
1560 IF M$<>"YES" THEN 1550
1570 PRINT "YOUR INSURANCE BET ";:IF W=21 THEN PRINT "WINS":V=V+U
1571 RETURN
...
1630 IF V=0THENPRINT"BIG DEAL......":END
...
1671 PRINT"YOU MAY DOUBLE THE 1ST 2 CARDS"
