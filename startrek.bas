...
1560 PRINT TAB(3);CHR$(27);"[7m";"  COMBAT AREA      CONDITION RED  ";
1561 PRINT CHR$(27);"[0m"
1562 IF S>200 THEN PRINT:GOTO 1590
1580 PRINT TAB(3);CHR$(27);"[7m";"      SHIELDS DANGEROUSLY LOW     ";
1581 PRINT CHR$(27);"[0m"
...
2020 PRINT:PRINT TAB(10);CHR$(27);"[7m";"** FATAL ERROR **";
2021 PRINT CHR$(27);"[0m""YOU'VE JUST STRANDED YOUR SHIP IN SPACE."
...
4551 PRINT CHR$(27);"[7m";"*** KLINGON DESTROYED ***"
4552 PRINT CHR$(27);"[0m":PRINT:GOTO 4580
...
5110 PRINT:PRINT CHR$(27);"[7m";"*** KLINGON DESTROYED ***";
5111 PRINT CHR$(27);"[0m":K3=K3-1:K9=K9-1:IF K9<=0 THEN 6370
...
6901 IF C$="*RED*" THEN GOSUB 9270:GOTO 7260  
6902 IF C$="DOCKED" THEN GOSUB 9280:GOTO 7260
...
9270 PRINT CHR$(27);"[7m";"*RED*";CHR$(27);"[0m":RETURN
9280 PRINT CHR$(27);"[7m";"DOCKED";CHR$(27);"[0m":RETURN
9999 END